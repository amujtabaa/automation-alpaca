...
Session type protocols and cross-cutting practices for Codex Fast development work.
...
protocol. Apply the workflow-worthy checklist in `.Codex/commands/team-plan.md`; if
