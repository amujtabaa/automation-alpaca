...
2. **Before starting new work**, rename current session to descriptive name:
   ...
   - `session-002-maillayer-deployment.md`
...
- `email-infrastructure` - Cold email, Maillayer, SES, DNS records
...
| **Username** | ubuntu |
| **OS** | Ubuntu 24.04 LTS |
| **Specs** | 32 GB RAM, 8 vCPUs, 640 GB SSD |
| **Purpose** | Maillayer + Coolify deployment |
...
> ⚠️ **Keep repo private** - contains credentials
