...
# Unban an IP
ssh root@server "fail2ban-client set sshd unbanip 192.168.1.100"

# Ban an IP manually
ssh root@server "fail2ban-client set sshd banip <YOUR_SERVER_IP>"
...
After configuring protection layers, proceed to **[operations.md](vps-security-operations.md)** for:
