...
| Module | When to Read |
|--------|--------------|
| **[setup.md](vps-security-setup.md)** | New server setup, SSH hardening, user creation, auto-updates |
| **[protection.md](vps-security-protection.md)** | Firewall config, Fail2ban, Cloudflare, intrusion detection |
| **[operations.md](vps-security-operations.md)** | Ongoing maintenance, automation scripts, emergency recovery, provider tips |
