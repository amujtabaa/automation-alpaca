...
For a simple, proven setup that works (matches example.com and example.com):
...
- Cloudflare provides two nameservers (e.g., `<NS1>.ns.cloudflare.com`, `<NS2>.ns.cloudflare.com`)
