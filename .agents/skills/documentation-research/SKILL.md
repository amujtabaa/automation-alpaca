...
Two registries for discovering and installing AI coding skills. Both support Codex.

### Context7 (ctx7 CLI)

The Context7 Skills Registry is a centralized system for discovering and installing AI coding skills across assistants (Codex, Cursor, Codex, etc.).
...
| `ctx7 skills list --Codex`             | -         | List installed skills           |
...
npx skills add anthropics/Codex-skills
```
...
**Steps**:
1. Read ".Codex/skills/documentation-research/SKILL.md" for scripts and error prevention
...
```bash
# Correct
uv run "C:/Github/project/.Codex/skills/documentation-research/context7-scripts/get_docs.py" "/org/lib"
