...
## 🏗️ Codex Fast Framework Organization
...
```
/AGENTS.md                   # Central AI configuration - auto-loaded base
```
...
This structure supports the session-based workflow where all task and development management happens through session files in `.Codex/tasks/`.
