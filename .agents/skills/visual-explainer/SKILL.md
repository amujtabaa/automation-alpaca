...
**Output location:** Write to `.Codex/tasks/views/` (relative to the repo root). Use a descriptive filename based on content: `plan-review-auth-system.html`, `pipeline-flow.html`, `schema-overview.html`. The directory persists across sessions and is co-located with task files.

**Open in browser (cross-platform):**

- Windows: `start .Codex/tasks/views/filename.html` (in Git Bash) or `start "" ".Codex\tasks\views\filename.html"` (in cmd)
- macOS: `open .Codex/tasks/views/filename.html`
- Linux: `xdg-open .Codex/tasks/views/filename.html`
