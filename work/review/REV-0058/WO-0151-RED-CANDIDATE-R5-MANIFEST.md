# WO-0151 RED pre-flight candidate R5 manifest

Status: **controlling documentation-only R5 freeze; not an activation record**

Base commit: f1a40d69f301ad7f594a61f202d3bd380607b98a  
Branch: codex/arch-reset-2026-07-r1

R5 is an additive amendment to immutable R2, R3, and R4 candidate bodies. The
exact R5 review candidate is the R2 body plus the R3, R4, and R5 amendments.
R0 through R4 are retained negative evidence and grant no implementation or
...
| work/review/REV-0058/request-r5.md | 4ae8175c31b05253071e7a67b368d5d1a7fc7218c1767738452267dd7dc2dc8a |

The manifest intentionally excludes itself. Only this exact R2+R3+R4+R5
composite may receive R5 acceptance. Any change to a listed candidate file
