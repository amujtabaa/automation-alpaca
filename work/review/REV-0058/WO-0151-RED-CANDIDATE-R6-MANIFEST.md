# WO-0151 RED pre-flight candidate R6 manifest

Status: **controlling documentation-only R6 freeze; not an activation record**

Base commit: f1a40d69f301ad7f594a61f202d3bd380607b98a  
Branch: codex/arch-reset-2026-07-r1

R6 is an additive amendment to immutable R2, R3, R4, and R5 candidate bodies.
The exact R6 review candidate is the R2 body plus the R3, R4, R5, and R6
amendments. R0 through R5 are retained negative evidence and grant no
...
| work/review/REV-0058/request-r6.md | db6acfdb81404f3b1d8e92fdf6b6a19c54f59bbd5aea862bd0994cb0d252f5cb |

The manifest intentionally excludes itself. Only this exact R2+R3+R4+R5+R6
composite may receive R6 acceptance. Any change to a listed candidate file
