# WO-0152 R1 remediation 01 candidate manifest
...
This manifest freezes only the R1 + R1 remediation 01 composite. It does not
activate WO-0152 or authorize creation/execution of tests. The R0 and first-R1
packets/results are immutable retained negative preflight evidence:
...
R1 remediation 01 may correct only R1's two constructibility P1s under the
existing two-fixture authorization. It adds no third fixture, private
reconciliation reader, public API, production change, test implementation, or
operational capability.

## Frozen R1 remediation 01 candidate inputs
...
| work/queue/WO-0152-reset-kernel-e3-generation-conformance.md | 193d9976cf4e6437dcbb72e095304b8baf5cc3328e97af3868f8d0babf0ad980 |
| docs/adr/ARCH-RESET-2026-07-RATIFICATION.md | 91db96d21dcd9bf793ca4e790ef8bf092cc799e99f322df1009a361887779a38 |
| pkl/project/goals.md | de59b7f49ce5d8bf6197af03749714cd237297ac7fb02fb841ad019a0881a47a |
| pkl/architecture/architecture-map.md | b7ef9cc37841757dc3f59c95426d4868f788ecfb9f44036ba24ca3a6e99586fc |
| pkl/log.md | 6ad8f7058f7619a5363634bbfd67d9fd6ecd81c7ba8c0b3bb424e161d40a955d |
| work/ledger.jsonl | 7e8ed97c33529416128abafec2d3042b382274a8401e3690abf630806490ab5a |
...
- The reviewer-owned result path `work/review/REV-0059/result-r1-r1.md` is absent.
- No production or existing test source is part of the R1 remediation 01 candidate delta.
...
- The reviewer must re-hash every listed input, verify the absent paths, verify the exact
  tracked/untracked delta and `git diff --check`, and write only `result-r1-r1.md`.
