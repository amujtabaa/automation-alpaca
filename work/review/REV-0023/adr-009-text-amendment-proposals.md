# PROPOSAL (not applied) — ADR-010 text amendments for the two Phase A contradictions

Status: **ACCEPTED by Ameen 2026-07-12** (in-chat: "I'll accept both ADR-010 proposals"); applied to the ADR + implemented by WO-0029A. The ADR itself is untouched — these are
