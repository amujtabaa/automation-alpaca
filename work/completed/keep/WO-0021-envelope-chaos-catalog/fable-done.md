...
| Spec observations | no phase-exit disposition exists (catalog assumed one — ADR-010 §2 gap for the review); reconciliation-inferred fills not envelope-bridged (WO-0020 deferred item, catalog-adjacent) |
