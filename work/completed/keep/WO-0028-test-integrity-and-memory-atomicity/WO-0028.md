...
record_reconciliation: "WO-0120 (2026-07-20) verified fable-done.md status VERIFIED and the existing WO-0028 DISPOSED ledger row; a canonical CLOSED ledger row is appended."
owner: Ameen
created: 2026-07-12
---
...
9. (Amended at execution start, 2026-07-12) Pin the REV-0023 Phase A repros as
...
## Done-when
- [ ] All 8 items landed; every W3 mutation from the REV-0023 matrix killed, evidence pasted.
