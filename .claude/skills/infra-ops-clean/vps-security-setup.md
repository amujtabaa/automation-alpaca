...
ssh-keygen -t ed25519 -C "your_email@example.com" -f ~/.ssh/myserver-key

# Or RSA 4096-bit (wider compatibility)
ssh-keygen -t rsa -b 4096 -C "your_email@example.com" -f ~/.ssh/myserver-key
```
...
After completing setup, proceed to **[protection.md](vps-security-protection.md)** to configure:
- UFW Firewall
- Fail2ban
- Cloudflare
- Intrusion detection
