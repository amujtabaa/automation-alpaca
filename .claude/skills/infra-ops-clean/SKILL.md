...
| `migration/cloudflare-mcp-setup.md` | Cloudflare MCP setup for DNS CRUD via Claude tool calls                                             |
...
| File               | Purpose                                                                                                                           |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------- |
| `CUSTOM-CLAUDE.md` | Example CLAUDE.md additions for infra work (session workflow, SSH conventions); copy relevant parts into your project's CLAUDE.md |
